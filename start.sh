...
node node_modules/aws-iot-device-sdk/examples/device-example.js --host-name=az6wto8a6h0jn-ats.iot.us-east-1.amazonaws.com --private-key=kio-smart-contracts-iot-device.private.key --client-certificate=kio-smart-contracts-iot-device.cert.pem --ca-certificate=root-CA.crt --client-id=sdk-nodejs-e57c917f-032c-4778-8184-69116bc19f76
